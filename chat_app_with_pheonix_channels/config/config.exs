...
config :chat_app_with_pheonix_channels,
...
config :chat_app_with_pheonix_channels, ChatAppWithPheonixChannelsWeb.Endpoint,
  ...
  render_errors: [
    formats: [
      html: ChatAppWithPheonixChannelsWeb.ErrorHTML,
      json: ChatAppWithPheonixChannelsWeb.ErrorJSON
    ],
    layout: false
  ],
  pubsub_server: ChatAppWithPheonixChannels.PubSub,
  live_view: [signing_salt: "SEw03M+/"]
...
config :esbuild,
  version: "0.17.11",
  chat_app_with_pheonix_channels: [
    args:
